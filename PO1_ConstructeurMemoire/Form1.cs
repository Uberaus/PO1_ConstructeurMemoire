namespace PO1_ConstructeurMemoire
{
    public partial class Form1 : Form
    {
        ...
        private void button_ajouterJoueur_Click(object sender, EventArgs e)
        {
            ...
            {
                errorProvider_ajouterJoueur.SetError(comboBox_ajouterJoueurEquipe, "Veuillez choisir une �quipe");
                erreur = true;
            }
            else
            {
        ...
        private void button_modifierEquipeNom_Click(object sender, EventArgs e)
        {
            ...
            {
                errorProvider_modifierEquipe.SetError(listBox_equipes, "Veuillez choisir une �quipe");
                erreur = true;
            }
            else
            {
